...
class BikeAdvertisementTest {
    ...
    void testCreateWithTwoParameters() {
        ...
        assertEquals("Gyerekkori BMX", advertisement.getText());
    ...
    void testCreateWithThreeParameters() {
        ...
        assertEquals("Női 26-os bicikli", advertisement.getText());
    ...
    void testCreateWithFourParameters() {
        ...
        assertEquals("20-as gyerek mountain bike", advertisement.getText());
    ...
    void testCreateWithFiveParameters() {
        ...
        assertEquals("felnőtt férfi hegyi terepbicikli", advertisement.getText());
