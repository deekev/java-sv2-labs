...
class LostAndFoundOfficeTest {
    ...
    void init() {
        ...
        office.sortProperties();
    }

    @Test
   void testFindLostProperty() {
       LostProperty expected = office.findLostProperty("színes esernyő", LocalDate.of(2021, 6, 29));
   ...
   void testFindLostPropertyNotFound() {
        Exception ex = assertThrows(IllegalArgumentException.class,
                () -> office.findLostProperty("xyz", LocalDate.of(2021, 6, 29)));
